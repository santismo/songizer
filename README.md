...
## One download, six instruments for musical decisions

Download **`Songizer-Suite-1.0.0-macOS.dmg`** from the [latest release](https://github.com/santismo/songizer/releases/latest), open it, then double-click **Install Songizer Suite.command**. It installs the Audio Units into your user Components folder and Repeatizer into `~/Applications`; existing copies are backed up first.
...
4. If Repeatizer is not listed immediately, open `~/Applications/Repeatizer.app` once, then restart Logic Pro.
...
| --- | --- | --- | --- |
| [Repeatizer](https://github.com/santismo/repeatizer) | 1.10.1 | Repeat, swing, and pattern treatment for a phrase you play. | AUv3 MIDI FX app extension |
